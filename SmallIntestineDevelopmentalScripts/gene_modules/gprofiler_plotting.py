...
# Plotting functions - 'GProfiler-official version' - script from 
# https://github.com/theislab/single-cell-tutorial/blob/master/latest_notebook/gprofiler_plotting.py
# with minor modification for legend placement
...
def plot_enrich(data, n_terms=20, save=False):
    ...
    #modified legend placement for figure saving (Anna Laddach)
